    ...
    return {
      ...
      onLoad: function(widget) { 
        ...
        $.Topic(pubsub.topicNames.PRODUCT_ADDED_TO_PURCHASE_LIST_SUCCESS).subscribe(function(publishableData){
          ...
          var wlLinkObj = {url: navigation.getPathWithLocale('/purchaseList/'+ publishableData.purchaseList.purchaseListId)};
      ...
      handleAddProductToPurchaseListError: function(){
      ...
      addItemToPurchaseList: function(widget, purchaseList) {
        ...
        self.purchaseListViewModel().
             addItemToPurchaseList(purchaseList,
                                   items,
                                   self.elements['purchase-list'].handleAddProductToPurchaseListSuccess,
                                   self.elements['purchase-list'].handleAddProductToPurchaseListError);
      },
