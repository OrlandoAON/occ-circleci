        ...
        navigation.setLoginHandler(function(data) {
          ...
          $.Topic(pubsub.topicNames.PAGE_READY).subscribe(function(pageEvent) {
            if (pageEvent) {
              ...
              if ((navigation.loginHandlerPage == undefined) || (navigation.loginHandlerPage == null) || (pageEvent.path !== undefined && pageEvent.path !== null && navigation.loginHandlerPage.indexOf(pageEvent.path) == -1)) {
                return;
              }
            }
