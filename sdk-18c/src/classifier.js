...
function classify(path) {
  ...
  switch (true) {
    case /global$/.test(path):
      return PuttingFileType.APPLICATION_LEVEL_JAVASCRIPT_DIRECTORY
    case /snippets\/[^/]*$/.test(path):
      return PuttingFileType.GLOBAL_SNIPPETS_LOCALE_DIRECTORY
    case /snippets$/.test(path):
      return PuttingFileType.GLOBAL_SNIPPETS_DIRECTORY
    case /stack$/.test(path):
      return PuttingFileType.STACKS_DIRECTORY
    case /stack\/[^/]*$/.test(path):
      return PuttingFileType.STACK
    case /theme\/[^/]*$/.test(path):
      return PuttingFileType.THEME
    case /theme$/.test(path):
      return PuttingFileType.THEMES_DIRECTORY
    case /element\/[^/]*$/.test(path):
      return PuttingFileType.GLOBAL_ELEMENT
    case /element$/.test(path):
      return PuttingFileType.GLOBAL_ELEMENTS_DIRECTORY
    case /widget$/.test(path):
      return PuttingFileType.WIDGETS_DIRECTORY
