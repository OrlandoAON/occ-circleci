...
const grabGlobalElement = require("./elementGrabber").grabGlobalElement
...
const grabWidgetElements = require("./elementGrabber").grabWidgetElements
...
function grab(node, clean) {
  ...
  // User wants the complete works. Need to wait for everything to finish.
  return grabAllStacks()
    .then(grabAllWidgets)
